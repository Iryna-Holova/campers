...
import css from './CampersSkeleton.module.css';

const CampersSkeleton = () => {
  return (
    <li className={css.card}>
      ...
      <div className={css.details}>
        ...
        <div className={css.features}>
          ...
          <div className={css.features_item} style={{ width: '142px' }}></div>
          <div className={css.features_item} style={{ width: '109px' }}></div>
          <div className={css.features_item} style={{ width: '123px' }}></div>
          <div className={css.features_item} style={{ width: '116px' }}></div>
          <div className={css.features_item} style={{ width: '87px' }}></div>
          <div className={css.features_item} style={{ width: '87px' }}></div>
          <div className={css.features_item} style={{ width: '154px' }}></div>
        </div>
...
export default CampersSkeleton;
